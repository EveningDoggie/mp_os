    ...
    size_t values_count)
{
    ...
    else if (memory_start != current_block) //����� ���� ��������� ����
    {
    ...
    if (size_optimal==-1 || size_optimal==get_space_size()+1) //���������� ������ �� �������
    {
    ...
    if (right_block_size <= get_occupied_block_minimum_size()) //������ ���� ����, ���� ������ ������� ����� = 0 ��� ������ ����������� (����+������� - ����������� �� �����)
    {
...
inline size_t allocator_boundary_tags::get_occupied_block_minimum_size() const
{
    ...
    return get_occupied_block_metadata_size() + 8; //����������� ����� ������ �������� ���� ������� �� ����� ������������ (����������� �� �����: ������ ������� �������� �� 8 �� 10 �)
}
