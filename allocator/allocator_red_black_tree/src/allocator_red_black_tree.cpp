...
inline void* allocator_red_black_tree::get_first_occupied_block_address() const
{
...
inline void allocator_red_black_tree::set_first_occupied_block_address(void* pointer)
{
